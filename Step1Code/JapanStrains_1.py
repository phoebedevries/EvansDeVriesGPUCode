...
exxfilename = "Exx_parallel_step1_%s" % PROBLEM_SIZE
eyyfilename = "Eyy_parallel_step1_%s" % PROBLEM_SIZE
ezzfilename = "Ezz_parallel_step1_%s" % PROBLEM_SIZE
exyfilename = "Exy_parallel_step1_%s" % PROBLEM_SIZE
exzfilename = "Exz_parallel_step1_%s" % PROBLEM_SIZE
eyzfilename = "Eyx_parallel_step1_%s" % PROBLEM_SIZE
